<template>
  <div class="relative">
    ...
    <div class="flex flex-wrap lg:flex-row justify-between items-center">
      <div class="">
        <h1 class="admin-h1 my-3">Sub Category</h1>
        <a><h6>Parent Category : {{categoryname}}</h6></a>
      </div>
        ...
        <table class="w-full">
          <thead class="bg-grey-light">
            <tr class="border-b">
              ...
              <th class="text-left text-sm px-2 py-2 text-grey-darker">Sub Category name </th>
            ...
            <tr class="border-b" v-for="(category,k1) in categories" :key="k=k1+1">
              ...
              <td class="py-3 px-2">
                <div class="flex items-center">                
                  ...
                  <a href="#" @click="deletecategory(category.id)" class="cursor-pointer" title="Show">
                  ...
                  <a :href="url+'/admin/categoryvendor/'+category.id+'/add'"  class="cursor-pointer" title="Add Vendor">
              ...
              <td>
                <div class="flex items-center">     
                  <a :href="url+'/admin/categoryvendor/'+category.id+'/show'"  class="underline cursor-pointer" >Vendor</a><span class="mx-1">{{category.vendorcount}}</span>
                </div>
             </td>
            </tr>
          ...
          <div class="modal-body">
                ...
                <div class="flex items-center">
                  <div class="w-ful"> 
                    <div class="my-2 w-full">
                      ...
                      <div class="my-2 w-full lg:w-3/4 flex items-center text-sm">
            ...
            <div class="flex items-center">
              <div class="my-2 w-full lg:w-3/4">
                <input type="button" name="" class="btn btn-submit blue-bg text-white rounded px-3 py-1 mr-3 text-sm font-medium cursor-pointer" value="submit" @click="addcategory()">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="modal-body">
            <div class="">
              ...
              <div class="my-2 w-full">
                ...
                <span v-if="errors1.editname" class="text-red-500 text-xs font-semibold">{{errors1.editname[0]}}</span>
              </div>
              <div class="modal-body">
                <div class="flex items-center">
                  <div class="w-full"> 
            ...
            <div class="">
              <div class="my-2 w-full lg:w-3/4 ">
                <input type="button" name="" value="submit" @click="updatecategory(edit.id)" class="btn btn-submit blue-bg text-white rounded px-3 py-1 mr-3 text-sm font-medium cursor-pointer">
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    props:['url','categoryid','categoryname'],
    data () {
      return {
        categories:[],
        edit:[],
    ...
    methods:
    {
      getlist(page=1)
      {
        axios.get('/admin/category/'+this.categoryid+'/list?page='+this.page+'&perpage='+this.per_page+'&search='+this.searchresult).then(response=>{
      ...
      {
        this.editshow=1;
        axios.get('/admin/subcategory/'+id+'/edit').then(response => {
      ...
      updatecategory(id)
      {
        axios.post('/admin/subcategory/'+id+'/update',{
          name:this.editname,
      ...
      deletecategory(id) 
      {
        ...
        swal({
          ...
          if (isConfirm) 
          {
            axios.delete('/admin/subcategory/'+id+'/delete').then(response => {
