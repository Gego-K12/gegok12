...
<div class="w-full">
    ...
    <div class=" flex flex-col lg:flex-row my-2">
                ...
                <div class="w-full lg:w-1/3 px-1 my-1">
                    <div class="bg-white custom-shadow px-4 py-3 border flex items-center">
                        <div class="w-20 h-20 rounded-full bg-light-blue flex items-center justify-center text-blue-500">
                            <svg class="w-10 h-10 fill-current" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 15.692 15.692" style="enable-background:new 0 0 15.692 15.692;" xml:space="preserve">
                                <g>
                                    <g>
                ...
                <div class="w-full lg:w-1/3 px-1 my-1">
                    <div class="bg-white custom-shadow px-4 py-3 border flex items-center">
                        <div class="w-20 h-20 rounded-full bg-light-red flex items-center justify-center text-red-500">
                            <svg class="w-10 h-10 fill-current" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 397.061 397.061" style="enable-background:new 0 0 397.061 397.061;" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                                            <path d="M86.204,67.918h31.347c1.443,0,2.612-1.17,2.612-2.612V2.612c0-1.443-1.169-2.612-2.612-2.612H86.204 c-1.443,0-2.612,1.17-2.612,2.612v62.694C83.592,66.749,84.761,67.918,86.204,67.918z" />
                                ...
                                <div class="text-sm my-1">
                                    ...
                                    <div class="flex justify-end">
                                        <a href="{{ $noticeboard->AttachmentPath }}" target="_blank">
                                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" class="w-5 h-5 fill-current mr-1 text-gray-600">
                                                <g>
                                                    <g>
                ...
                <div class="student_bg px-4 py-3 rounded-t flex">
                    ...
                    <div class="mx-5">
                        ...
                        <div class="py-1 text-white flex py-1">
                            <div class="my-1">
                                <svg id="Layer_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current text-gray-200">
                                    <g>
                    ...
                    <ul class="list-reset text-sm  item-title">
                        <li class="flex items-center border-b px-3 py-4">
                            <div class="flex items-center w-1/2">
                                <svg class="w-4 h-4 fill-current" style="color: #a8a8a8;" id="Layer_1" enable-background="new 0 0 480.001 480.001" height="512" viewBox="0 0 480.001 480.001" width="512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="flex items-center border-b px-3 py-4">
                            <div class="flex items-center w-1/2">
                                <svg class="w-4 h-4 fill-current" style="color: #a8a8a8;" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                    <g>
                                        <g>
                        ...
                        <li class="flex items-center border-b px-3 py-4">
                            <div class="flex items-center w-1/2">
                                <svg class="w-4 h-4 fill-current" style="color: #a8a8a8;" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
                                    <g id="XMLID_2374_">
                                        <g id="XMLID_707_">
                                            <g id="XMLID_708_">
                        ...
                        <li class="flex items-center border-b px-3 py-4">
                            <div class="flex items-center w-1/2">
                                <svg class="w-4 h-4 fill-current" style="color: #a8a8a8;" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                    <g>
                                        <g>
        ...
        : '' }}</p>
                        ...
                        <li class="flex items-center border-b px-3 py-4">
                            <div class="flex items-center w-1/2">
                                <svg class="w-4 h-4 fill-current" style="color: #a8a8a8;" height="512" viewBox="0 0 58 58" width="512" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="p-5 flex flex-col lg:flex-row md:flex-row items-stretch gap-5">
                    ...
                    <div class="w-full lg:w-1/2 md:w-1/2 flex flex-col items-center justify-center text-center border-b lg:border-b-0 md:border-b-0 lg:border-r md:border-r border-dashed border-gray-200 pb-5 lg:pb-0 md:pb-0 lg:pr-5 md:pr-5">
                        ...
                        <p class="text-xs text-gray-400 mt-1 flex items-center justify-center gap-1">
                            <svg class="w-3.5 h-3.5 fill-current text-gray-400" viewBox="0 0 24 24">
                                <path d="M7 2C5.9 2 5 2.9 5 4v16c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2H7zm5 18c-.83 0-1.5-.67-1.5-1.5S11.17 17 12 17s1.5.67 1.5 1.5S12.83 20 12 20zM17 16H7V5h10v11z" />
                            </svg>
    ...
    {
        {
            --
            var present = {
                !!trans($dashboard['presentPercentage']) !!
            };
            var absent = {
                !!trans($dashboard['absentPercentage']) !!
            };
            --
        }
    }
    var present = {
        !!trans($dashboard['presentDay']) !!
    };
    var absent = {
        !!trans($dashboard['absentDay']) !!
    };
