...
class InstallCertificateModule extends Command
{
    protected $signature = 'module:install-certificate';
    ...
    public function handle()
    {
        try {
            ...
            $repo = 'https://github.com/gego-k12/certificate.git';
            $package = 'gegok12/certificate:v1.0.x-dev';
            ...
            foreach (['certificate-routes', 'certificate-components', 'certificate-views', 'certificate-migrations', 'certificate-config'] as $tag) {
            ...
            $importLine = "import { registerCertificate } from './gcertificate'";
            ...
            if (! str_contains($content, 'registerCertificate(app)')) {
