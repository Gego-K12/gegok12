    ...
    <div class="flex flex-row items-center justify-between">
        ...
        <div class="flex items-center">
            <div class=" flex items-center mx-2">
                <a href="{{ route('admin.setting.states.update',['id'=>$stateDetail->id]) }}"  title="Edit" class="px-2 py-1 rounded ml-1 menuclick text-white bg-blue-500 text-xs">
    ...
    <div class="">                      
        <div class="flex flex-col lg:flex-row md:flex-row px-2 py-2">
            ...
            <div class="text-sm lg:w-3/4 md:w-3/4">
                <p class="leading-loose txt-gray-light">{{ $stateDetail->id }}</p>
            </div>
        </div> 
        ...
        <div class="flex flex-col lg:flex-row md:flex-row px-2 py-2">
            ...
            <div class="text-sm lg:w-3/4 md:w-3/4">
                <p class="leading-loose txt-gray-light">{{ $stateDetail->country->name }}</p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row md:flex-row px-2 py-2">
            ...
            <div class="text-sm lg:w-3/4 md:w-3/4">
                <p class="leading-loose txt-gray-light">{{ $stateDetail->name }}</p>
            </div>
        </div>
