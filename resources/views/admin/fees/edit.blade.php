...
@section('content')
	<div class="">
	    <h1 class="admin-h1 my-3 flex items-center">
	      	<a href="{{ url('/admin/fees') }}" title="Back" class="rounded-full bg-gray-100 p-2">
	    ...
	    @if($fee->fee_type == 'non_structural')
	    	<edit-fee-non-structural id="{{ $fee->id }}" mode="admin" class_id="{{ $fee->standardLink_id }}"></edit-fee-non-structural> 
	    @elseif($fee->fee_type == 'structural') 
	    	<edit-fee-structural id="{{ $fee->id }}" mode="admin"></edit-fee-structural> 
	    @endif
	</div>
@endsection