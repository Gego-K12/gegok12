...
@section('content')
    <!-- <div class="w-full">
        <div>
            <h1 class="admin-h1 my-3 flex items-center">
                <a href="{{ url('/teacher/video-conference/manage-invites/'.$conference->id) }}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        <div class="bg-white shadow px-4 py-3">
            ...
            <form method="post" action="{{url('teacher/video-conference/save-invites/'.$conference->id)}}" id="stream" enctype="multipart/form-data">
                @csrf
                @if(old('standard')!='')
    ...
    <add-teacher-invites url="{{ url('/') }}" conference_id="{{$conference->id}}" ></add-teacher-invites>
@endsection
