<template>
    <div class="relative">
        ...
        <Teleport to="#approve_leave">
            ...
            <ul class="list-reset flex text-xs profile-tab flex-wrap" v-if="this.type == 'apply'">
                    ...
                    <div class="bg-white shadow rounded-lg border border-grey-light p-4 h-full flex flex-col">
                        <div class="flex items-start justify-between mb-2">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1" v-if="type == 'check'">{{ leave.teacher_name }}</p>
                            </div>
    ...
    export default {
        ...
        methods:
        {
            getData(page=1)
            {
                ...
                {
                    axios.get('/teacher/leave/mylist?page='+page+statusQuery).then(response => {
                ...
                {
                    axios.get('/teacher/leave/list?page='+page+statusQuery).then(response => {
                        this.leaves         = response.data.data;
                        this.page_count     = response.data.meta.last_page;
                        this.total          = response.data.meta.total;
                        //console.log(this.leaves);
