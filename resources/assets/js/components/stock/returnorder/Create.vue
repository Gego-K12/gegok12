 ...
 <!-- *** main content *** -->
                  ...
                  <div class="flex flex-col lg:flex-row">
                    ...
                    <label for="" class="tw-form-label">Price Per Item</label>
                      ...
                      <input v-model="price_per_item" name="price_per_item"  value="price_per_item" type="number" placeholder="Price per Item" class="tw-form-control w-full"><span v-if="errors.price_per_item" class="text-red-500 text-xs font-semibold">{{errors.price_per_item[0]}}</span>
                    </div>
                    </div>
                  </div>
                  <!-- *** -->
                ...
                <div class="flex flex-col lg:flex-row">
                  <div class="w-full lg:w-1/2">
                    ...
                    <label for="" class="tw-form-label">Reason For Return</label>
                      ...
                      <textarea v-model="reason_for_return" name="reason_for_return"  value="reason_for_return" type="textarea" placeholder="Reason for Return" class="tw-form-control w-full"></textarea>
...
<script>
  ...
  methods:{
    ...
    formData.append('return_date', this.return_date);
                ...
                this.errors=[];
                 axios.post(this.url+'/'+this.mode+'/returnorder/'+this.product_id+'/add',formData).then(response => {
