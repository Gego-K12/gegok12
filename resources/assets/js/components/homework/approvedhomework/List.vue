                        ...
                        <tr class="border-b" v-for="homework in homeworks">
                            ...
                            <td class="py-3 px-2">
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="capitalize text-white rounded px-1 py-1 font-medium activate" @click="approveHomework(homework.id)" v-if="(role == 'principal' || role == 'admin') && homework.approve_status == 'pending' && homework.status == 'publish'" title="Approve">
                                    ...
                                    <a href="#" class="capitalize text-white  rounded px-1 py-1 font-medium activate" @click="rejectHomework(homework.id)" v-if="(role == 'principal' || role == 'admin') && homework.approve_status == 'pending' && homework.status == 'publish'" title="Reject">
        ...
        methods:{
            ...
            deleteHomework(id) 
            {
                ...
                swal({
                    ...
                    if (isConfirm) 
                    {
                        axios.delete(thisswal.url+ '/'+thisswal.mode+'/homework/delete/'+ id).then(response => {
