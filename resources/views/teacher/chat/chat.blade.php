...
@section('content')
    <div class="relative">
        <div class="flex justify-between mb-4 items-center">
            ...
            <form action="{{ url('/teacher/chats') }}" enctype="multipart form-data">
                <div class="">
                    <div class="flex items-center mx-2">
                        ...
                        <div class="date-select date-select_none dashboard-reset mx-1 lg:mx-0 md:mx-0">
                            <a href="{{ url('/teacher/chats') }}" id="do-reset" class="text-sm border bg-gray-100 text-grey-darkest py-1 px-4">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <div class="w-1/2 lg:w-1/6 px-2 my-5">
                        ...
                        <div class="leading-loose my-1">
                            <div class="text-sm font-semibold text-gray-800 capitalize flex items-center justify-between">
                                <a href="{{url('/teacher/chat',$room)}}">{{ $room->title }} </a>
                                @if($room->status == 1)
