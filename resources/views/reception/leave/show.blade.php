        ...
        <div class="flex flex-wrap lg:flex-row justify-between">
            <div>
                <h1 class="admin-h1 my-3 flex items-center">
                    ...
                    <span class="mx-3">Show Leave Application</span>
                </h1>
            </div>
        </div>
        ...
        <div class="flex">
            <table class="w-3/4">
                <tr class="border-b">
                    ...
                    <td class="py-3 px-10">
                        <p class="text-xs">{{ $leave->teacher->FullName }}</p>
                    </td>
                </tr>
                <tr class="border-b">
                    <td class="py-3 px-2">
                ...
                <tr class="border-b">
                    ...
                    <td class="py-3 px-10">
                        <p class="text-xs">{{ $leave->absentReason->title }}</p>
                    </td>
                </tr>
                <tr class="border-b">
                    <td class="py-3 px-2">
                ...
                <tr class="border-b">
                    ...
                    <td class="py-3 px-10">
                        <p class="text-xs">{{ $leave->leaveType->name }}</p>
                    </td>
                </tr>
                <tr class="border-b">
                    <td class="py-3 px-2">
                        <p class="font-semibold text-xs">Status</p>
                    </td>
                    <td class="py-3 px-10">
                        <p class="text-xs">{{ ucfirst($leave->status) }}</p>
                    </td>
                </tr>
                @if($leave->status != 'pending')
                    <tr class="border-b">
                        <td class="py-3 px-2">
                            <p class="font-semibold text-xs">Comments</p>
                        </td>
                        <td class="py-3 px-10">
                            <p class="text-xs">{{ $leave->comments }}</p>
                        </td>
                    </tr>
                @endif
            </table>
