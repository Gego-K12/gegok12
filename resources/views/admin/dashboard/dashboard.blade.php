...
@section('content')
    ...
    {{-- Plugin dashboard-widget hook: any installed plugin with has_dashboard_widget=true
         and portal=admin gets its resources/views/plugins/{slug}/dashboard-widget.blade.php
         included here automatically, so new plugins never require editing this file. --}}
    @foreach(\App\Models\Plugin::cachedHook('withDashboardWidgetFor', 'admin') as $installedPlugin)
        @includeIf($installedPlugin->dashboardWidgetViewName('admin'))
    @endforeach
@endsection
