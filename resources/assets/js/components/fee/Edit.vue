...
<script>
  ...
  export default {
    ...
    methods:
    {
      getList()
      {
        axios.get('/admin/fee/edit/list/'+this.id).then(response => {
      ...
      submitForm()
      {
        ...
        axios.post('/admin/fee/edit/'+this.id,formData,{headers: {'Content-Type': 'multipart/form-data'}}).then(response => {     
