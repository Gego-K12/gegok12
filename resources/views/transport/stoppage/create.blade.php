...
<div class="w-full lg:mx-2">
    <h1 class="admin-h1 my-3 flex items-center">
        ...
        <span class="mx-3">Add Stoppage</span>
    </h1>
    
    @include('partials.message')
    <div class="bg-white shadow px-4 py-4">
        <form method="POST" action="{{url('/admin/transport/stoppage/create')}}" enctype="multipart/form-data">
            @csrf
           <div class="flex flex-col">
              ...
              <div class="lg:mr-8 md:mr-8">
                <input type="text" name="name"  class="tw-form-control w-full"><br>
         ...
         <!--  <div class="flex flex-col">
              ...
              <div class="my-2 w-full">
                <input type="text" name="distance"  class="tw-form-control w-full"><br>
             ...
             <div class="flex flex-col">
              ...
              <div class="flex items-center">
               <div class="flex items-center lg:w-1/6 md:w-1/6"> <input type="radio" name="status" value="0"  class="tw-form-control"><span class="mx-2">Inactive</span></div>
               <div class="flex items-center lg:w-1/6 md:w-1/6"> <input type="radio" name="status" value="1" class="tw-form-control"><span class="mx-2">Active</span></div>
               </div>
               
                <span class="my-1"><p class="text-red-500 text-xs font-semibold">{{ $errors->first('status') }}</p></span>
              </div>
            </div>
                <div class="flex flex-col lg:flex-row md:flex-row">
                    <div class="tw-form-group w-full lg:w-1/2 md:w-1/2">
                        <div class="lg:mr-8 md:mr-8">
                            ...
                            <div class="mb-2 w-full relative">
                                <input type="text" name="address" class="tw-form-control w-full" id="address" value="{{old('address')}}" required="Address is required"  onkeyup="codeAddress()"> 
                 ...
                 <button type="submit" class="btn btn-submit blue-bg text-white rounded px-3 py-1 my-2 text-sm font-medium" onclick="codeAddress()">Submit</button>
        </form>
     </div>
...
@push('scripts')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places&key=AIzaSyDDH9FDGKCDD0o_bZYIJ46U_Na7T7neZTA"></script>
