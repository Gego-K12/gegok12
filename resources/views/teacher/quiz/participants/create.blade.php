      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/teacher/quiz/'.$topics_id.'/show') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add participant</span>
            </h1>
         </div>
      </div>
      @include('partials.message')
      <create-participant url="{{ url('/') }}" topics_id="{{ $topics_id }}"></create-participant>
   </div>
@endsection