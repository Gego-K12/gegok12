    ...
    <div>
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ $prev_url }}" class="rounded-full bg-gray-100 p-2" title="Back">
                <svg class="w-3 h-3 fill-current text-gray-700" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 492 492" style="enable-background:new 0 0 492 492;" xml:space="preserve" width="512px" height="512px">
                    <g>
                        <g>
                            <g>
    ...
    <div class="flex flex-col lg:flex-row md:flex-row">
                        ...
                        <ul class="flex justify-center">
                            <li class="mx-2">
                                <a href="{{url('/admin/student/edit/'.$user->name)}}" title="Edit Member" class="text-white text-xs flex items-center blue-bg rounded p-1" id="edit">
                                    <svg class="w-3 h-3 fill-current text-white" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                            ...
                            <li class="mx-2">
                                ...
                                <form action="{{ url('/admin/student/delete', ['name'=>$user->name]) }}" method="POST" class="text-white text-xs flex items-center bg-red-600 rounded p-1" id="delete" onsubmit="return confirm('Do you want to delete this student?')">
                                    @csrf
                                    @method('delete')

                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" class="w-3 h-3 fill-current text-white">
                                        <g>
                                            <g>
                                                <g>
                                                    <polygon points="353.574,176.526 313.496,175.056 304.807,412.34 344.885,413.804"></polygon>
                                                    ...
                                                    <path d="M17.379,76.867v40.104h41.789L92.32,493.706C93.229,504.059,101.899,512,112.292,512h286.74 c10.394,0,19.07-7.947,19.972-18.301l33.153-376.728h42.464V76.867H17.379z M380.665,471.896H130.654L99.426,116.971h312.474 L380.665,471.896z"></path>
                                                </g>
                                            </g>
                                        </g>
                                        <g>
                    ...
                    <ul class="list-reset text-xs leading-relaxed my-2">
                        <li class="flex py-1">
                            <div class="flex items-center">
                                <svg class="w-3 h-3 fill-current text-gray-800" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                        ...
                        <li class="flex py-1">
                            <div class="flex items-center">
                                <svg class="w-3 h-3 fill-current text-gray-800" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                    <g>
                                        <g>
                                            <path d="M411.631,190.282h-111.72c-9.899,0-17.923,8.023-17.923,17.923s8.023,17.923,17.923,17.923h111.72 c9.905,0,17.923-8.023,17.923-17.923S421.531,190.282,411.631,190.282z" />
                                        </g>
                                    </g>
                                    <g>
                                        <g>
                                            <path d="M411.631,285.872h-111.72c-9.899,0-17.923,8.023-17.923,17.923s8.023,17.923,17.923,17.923h111.72 c9.905,0,17.923-8.024,17.923-17.923S421.531,285.872,411.631,285.872z" />
                                        </g>
                                    </g>
                                    <g>
                                        <g>
                                            <path d="M494.077,55.263H17.923C8.023,55.263,0,63.286,0,73.185v365.629c0,9.899,8.023,17.923,17.923,17.923h476.154 c9.899,0,17.923-8.023,17.923-17.923V73.185C512,63.286,503.977,55.263,494.077,55.263z M476.154,420.891H35.846V91.109h440.308 V420.891z" />
                                        </g>
                                    </g>
                                    <g>
                                        <g>
                                            <path d="M155.93,143.683c-28.659,0-51.977,23.318-51.977,51.977s23.318,51.977,51.977,51.977 c28.659,0,51.977-23.318,51.977-51.977S184.589,143.683,155.93,143.683z M155.93,211.79c-8.896,0-16.131-7.235-16.131-16.131 c0-8.896,7.235-16.131,16.131-16.131c8.896,0,16.131,7.235,16.131,16.131C172.061,204.555,164.826,211.79,155.93,211.79z" />
                                        </g>
                                    </g>
                                    <g>
                                        <g>
                                            <path d="M155.93,248.837c-46.779,0-84.835,38.056-84.835,84.83v16.728c0,9.899,8.023,17.923,17.923,17.923h133.825 c9.899,0,17.923-8.018,17.923-17.917v-16.734C240.766,286.893,202.709,248.837,155.93,248.837z M106.952,332.471 c0.633-26.46,22.362-47.795,48.978-47.795c26.61,0,48.338,21.328,48.972,47.795H106.952z" />
                                        </g>
                                    </g>
                                </svg>
                        ...
                        <li class="flex py-1">
                            <div class="flex items-center">
                                <svg class="w-3 h-3 fill-current text-gray-800" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                                    <g>
                                        <g>
                                            <g>
                ...
                <div class="my-4 px-2">
                    ...
                    <ul class="list-reset text-xs leading-loose my-2">
                        <li class="flex items-baseline py-1">
                            <svg class="w-3 h-3 fill-current text-gray-800" height="682pt" viewBox="-119 -21 682 682.66669" width="682pt" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="flex py-1 items-center">
                            <svg class="fill-current w-3 h-3 text-gray-800" height="512" viewBox="0 0 58 58" width="512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="flex py-1 items-center">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" class="w-3 h-3 fill-current text-gray-800">
                                <g>
                                    <g>
        ...
        <div class="w-full lg:w-4/5 md:w-4/5 lg:mx-8 md:mx-8">
            <div class="flex lg:items-center lg:justify-between flex-col lg:flex-row relative">
                ...
                <div class="flex items-center">
                    <div class="py-4 mr-5">
                     ...
                     <div class="py-4 mr-5">
                            <a href="{{ url('/admin/student/show/pdf/'.$user->name) }}" target="_blank" class="text-xs">
                                <div class="bg-gray-200 rounded-full w-8 h-8 lg:w-10 md:h-10 md:w-10 md:h-10 flex items-center justify-center mx-auto hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 lg:w-5 lg:h-5 md:w-5 md:h-5 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                              </div>
                            <span class="hover:font-semibold hidden lg:block md:block">Download PDF<span>
                          </a>
                            </div>
                    <div onclick="showsidebar('student-profile-menu')" class="bg-white rounded-full w-6 h-6 ml-auto flex items-center justify-center cursor-pointer">
                        <svg id="Capa_1" enable-background="new 0 0 515.555 515.555" height="512" viewBox="0 0 515.555 515.555" width="512" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-current text-gray-600">
                            <path d="m303.347 18.875c25.167 25.167 25.167 65.971 0 91.138s-65.971 25.167-91.138 0-25.167-65.971 0-91.138c25.166-25.167 65.97-25.167 91.138 0"></path>
                            <path d="m303.347 212.209c25.167 25.167 25.167 65.971 0 91.138s-65.971 25.167-91.138 0-25.167-65.971 0-91.138c25.166-25.167 65.97-25.167 91.138 0"></path>
                            <path d="m303.347 405.541c25.167 25.167 25.167 65.971 0 91.138s-65.971 25.167-91.138 0-25.167-65.971 0-91.138c25.166-25.167 65.97-25.167 91.138 0"></path>
                        </svg>
                    </div>
                    <div id="student-profile-menu" class="hidden absolute top-0 right-0 bg-white shadow mt-10 rounded">
                        <div class="flex flex-col text-xs w-40 my-1">
                            ...
                            <form method="POST" action="{{ url('/admin/user/updateStatus/'.$user->name) }}" onsubmit="return confirm('Do you want to change the status?')">
                                @csrf
                                <input type="hidden" name="status" value="active">
                                <button type="submit" class="w-full text-left capitalize text-teal-500 rounded px-4 py-1 font-medium my-1 lg:my-0 md:my-0 mr-2">Activate</button>
                            </form>
                            @else
                            ...
                            <form method="POST" action="{{ url('/admin/user/updateStatus/'.$user->name) }}" onsubmit="return confirm('Do you want to change the status?')">
                                ...
                                <button type="submit" class="w-full text-left capitalize text-red-600 rounded px-4 py-1 font-medium my-1 lg:my-0 md:my-0 mr-2">Deactivate</button>
                            </form>
                            @endif
                            ...
                            <form method="POST" action="{{ url('/admin/user/updateStatus/'.$user->name) }}" onsubmit="return confirm('Do you want to change the status?')">
                                @csrf
                                <input type="hidden" name="status" value="exit">
                                <button type="submit" class="w-full text-left capitalize text-teal-500 rounded px-4 py-1 font-medium my-1 lg:my-0 md:my-0 mr-2">Exit</button>
                            </form>
                            @endif

                            @if($user->email != null)
                            @if($user->email_verified == 1)
                            <a href="{{ url('/admin/user/resetPassword/'.$user->id) }}" onclick="return confirm('Do you want to reset password for this student?')" class="capitalize text-gray-700 rounded px-4 py-1 mr-2 font-medium my-1 lg:my-0 md:my-0">reset Password</a>
                            @endif
            ...
            <div class="leading-relaxed">
                ...
                @livewire('admin.change-credential', ['name' => $user->name])
            </div>
            <div class="bg-white shadow my-5">
                @livewire('admin.student.profile.profile-tabs', ['name' => $user->name])
            </div>
