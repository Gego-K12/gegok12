...
<!-- *** heading ***-->
                   ...
                   <a :href="url+'/admin/product/'+this.productid+'/show'" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <!-- *** -->
               ...
               <!--  <div class="flex flex-col lg:flex-row">
                    ...
                    <label for="" class="tw-form-label">Unique code</label>
                      ...
                      <input v-model="unique_code_prefix" name="unique_code_prefix"  value="unique_code_prefix" type="text" placeholder="Unique code" class="tw-form-control w-full"><span v-if="errors.unique_code_prefix"><small class="text-red-500">{{errors.unique_code_prefix[0]}}</small></span>
                    </div>
                    </div>
                    ...
                    <label for="" class="tw-form-label">Quantity</label>
                      ...
                      <input v-model="quantity" name="quantity"  value="quantity" type="number" placeholder="quantity" class="tw-form-control w-full"><span v-if="errors.quantity"><small class="text-red-500">{{errors.quantity[0]}}</small></span>
                    </div>
                    </div>
                    </div> -->
              <!-- *** -->
        ...
        for(let i=0;i<this.specifications.length;i++)
        {
          ...
          else
          {
            formData.append('detail'+i,'');
                ...
                this.errors=[];
                 axios.post('/admin/product/'+this.productid+'/update',formData).then(response => {
               ...
               getData()
          {
            ...
            axios.get('/admin/product/'+this.productid+'/editshow').then(response=>{
                  console.log(response);
                   ...
                   this.depreciation_rate=this.edit.depreciation_rate;
                   this.in_use=this.edit.in_use;
                   this.bill_scan=this.edit.bill_scan;
                   this.remarks=this.edit.remarks;
                   this.ownership_tracking=this.edit.ownership_tracking;
                   this.location_tracking=this.edit.location_tracking;
                   this.maintainence_tracking=this.edit.maintainence_tracking;
                   this.warranty_period=this.edit.warranty_period;
                   for (var i =0;i<this.specification.length;i++) {
                        this.specifications.push({ title:this.specification[i].title,detail:this.specification[i].detail,});
                      }
                    
                   if(this.edit.warranty_period != null)
                        {
                          this.select = 1;
                          this.warrantyshow=true;
                          this.month=this.warranty_period.month;
                          this.year=this.warranty_period.year;
                        }
                        else
                        {
                          this.select = 0;
