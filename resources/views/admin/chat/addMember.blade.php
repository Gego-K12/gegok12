...
@section('content')
    <div class="w-full">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/admin/chat/'.$room->id) }}" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <span class="mx-3">Add Member to Chat</span>
        </h1>
    </div>
    ...
    <div class="tw-form-group ">
        <div class="">
            <div class="mb-2">
                <add-roommember url="{{ url('/') }}" school_id="{{ $room->school_id }}" room_id="{{ $room->id }}"></add-roommember>
            </div>
        </div>
    </div>
@endsection   