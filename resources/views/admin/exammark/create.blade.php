...
@section('content')
    <div class="">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ url('/admin/exammarks/show/'.$schedule->id) }}" id="submit-btn" class="btn btn-submit blue-bg text-white rounded px-3 py-1 mr-3 text-sm font-medium">Export</a>
        </div>
        @include('partials.message')
        <create-exammark id="{{ $schedule->id }}" url="{{ url('/') }}"></create-exammark>  
    </div>
@endsection