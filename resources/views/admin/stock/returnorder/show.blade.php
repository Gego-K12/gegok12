...
<span class="mx-3">Return Order Details</span>
</h1>
</div>
   ...
   <div class="w-full lg:w-3/4 lg:mr-8 md:mr-8 custom-table py-4">
        <table class="w-full">
            ...
            <tr class="border-t-2 border-b-2">
                ...
                <td class="py-3 px-2">{{ $returnorder->quantity}}  </td>
            </tr>

            <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Reason For return</td>
                <td class="py-3 px-2">{{  $returnorder->reason_for_return}}</td>
            </tr>

            <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Return Date</td>
                <td class="py-3 px-2">{{  $returnorder->return_date}} </td>
            </tr>
