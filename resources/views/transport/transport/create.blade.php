      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/admin/students') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add Transport Details</span>
            </h1>
         </div>
      </div>
      @include('partials.message')
      <create-transport url="{{ url('/') }}" ref_name="{{ $ref_name }}"></create-transport>
   </div>
@endsection
