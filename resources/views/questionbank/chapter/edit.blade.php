...
@section('content')
	<div class="relative">
     <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/receptionist/calllog') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Edit Call Log</span>
    </h1>
      @include('partials.message')
      <edit-call-log url="{{ url('/') }}" id="{{ $calllog->id }}" mode="receptionist"></edit-call-log>
   </div>
@endsection