...
class InstallAlumniModule extends Command
{
    protected $signature = 'module:install-alumni';
    ...
    public function handle()
    {
        try {
            ...
            foreach (['alumni-routes', 'alumni-components', 'alumni-views', 'alumni-migrations', 'alumni-config'] as $tag) {
            ...
            $customRoutes = [
                "if (file_exists(base_path('routes/galumni.php'))) {\n    require base_path('routes/galumni.php');\n}",
            ];
            ...
            $importLine = "import { registerAlumni } from './galumni'";
            ...
            if (! str_contains($content, 'registerAlumni(app)')) {
