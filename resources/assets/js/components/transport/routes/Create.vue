 ...
 <!-- *** main content *** -->
                ...
                <span v-if="errors['status']" class="text-red-500 text-xs font-semibold">{{errors['status'][0]}}</span>
                  ...
                  <!-- *** -->
                    ...
                    <label class="flex items-center w-2/5 tw-form-label" for="" >Stoppage</label>
                     <label  class="flex items-center w-2/5 tw-form-label lg:ml-2" for="" >Pickuptime</label>
                      <label class="flex items-center w-2/5 tw-form-label lg:ml-2" for="" >Drop time</label>
        ...
        <div v-for="(specification,k1) in specifications" :key="k1" class="">
          <div class="flex items-center mb-3">
            <div class="flex-col w-2/5">
             ...
             <div class="flex-col w-2/5">
                <input type="time"  v-model="specification.pickup_time" placeholder="Pickup time" class="tw-form-control  w-11/12 lg:ml-2"> <br>
                 <span v-if="errors['pickup_time'+k1]" class="text-red-500 text-xs font-semibold">{{errors['pickup_time'+k1][0]}}</span>
             </div>
              <div class="flex-col w-2/5">
                <input type="time"  v-model="specification.drop_time" placeholder="Drop time" class="tw-form-control  w-11/12 lg:ml-2"> <br>
        ...
        for(let i=0;i<this.specifications.length;i++)
        {
          ...
          else
          {
            formData.append('drop_time'+i,'');
                ...
                this.errors=[];
                 axios.post("/admin/transport/route/store",formData).then(response => {
