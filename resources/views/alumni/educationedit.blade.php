...
@section('content') 
    <div class="w-full">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/alumni/dashboard') }}" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <span class="mx-3">Edit Education</span>
        </h1>
        @include('partials.message')
        <edit-alumni-education url="{{ url('/') }}" ></edit-alumni-education>
    </div>
@endsection