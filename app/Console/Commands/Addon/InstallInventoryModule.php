...
{
    protected $signature = 'module:install-inventory';
    ...
    public function handle()
    {
        try {
            ...
            foreach (['inventory-routes', 'inventory-components', 'inventory-views', 'inventory-migrations', 'inventory-config'] as $tag) {
            ...
            $importLine = "import { registerInventory } from './ginventory'";
            ...
            if (! str_contains($content, 'registerInventory(app)')) {
