...
class TelephoneDirectoryController extends Controller
{
    ...
    {
        return view('/reception/telephonedirectory/index');
    }
    ...
    {
        //
        return view('/reception/telephonedirectory/create');
    }
    ...
    public function show($id)
    {
        ...
        return view('/reception/telephonedirectory/show',['telephonedirectory' => $telephonedirectory]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('/reception/telephonedirectory/edit',['telephonedirectory' => $telephonedirectory]);
    }
