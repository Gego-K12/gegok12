        ...
        <div class="flex flex-wrap lg:flex-row justify-between">
            <div>
                <h1 class="admin-h1 mb-5 flex items-center">
                    <a href="{{ url('/teacher/workpermissions') }}" title="Back" class="rounded-full bg-gray-300 p-2">
                    ...
                    <span class="mx-3">Approve Work Permission</span>
                </h1>
            </div>
        </div>
        @include('partials.message')
        <workpermission-approve url="{{ url('/') }}" id="{{ $permission->id }}" status="approve"></workpermission-approve>
    </div>
@endsection
