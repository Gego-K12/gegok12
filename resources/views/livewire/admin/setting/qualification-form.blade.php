    ...
    <div class="bg-white shadow-lg rounded-xl border overflow-hidden">
        <div class="flex items-center px-6 py-4 border-b bg-gray-50">
            <div class="bg-gray-200 p-1 rounded-full">
                <a href="{{ url('admin/setting/qualifications') }}">
            ...
            <div class="text-xl ml-3 font-bold">
                 {{ $qualificationEditId != '' ? 'Update' : 'Add' }} Qualification
            </div>
        </div>

    <div class="p-6">

 <form wire:submit.prevent="submitQualification" method="POST" class="">
        @csrf
    ...
    <div class="flex flex-col lg:flex-col">
     ...
     <div class="flex flex-col lg:flex-row">
        ...
        <label for="" class="tw-form-label">Name<span class="text-red-500">*</span></label>
          ...
          <input name="display_name" value="" type="text" placeholder="Name" class="tw-form-control w-full" wire:model.live="display_name">
          @error('display_name')<span class="text-red-600 text-xs font-normal"><strong>{{ $message }}</strong></span>@enderror
        </div>
        </div>
      </div>
      ...
      <div class="tw-form-group w-full lg:w-1/2">
        <div class="lg:mr-8 ">
          <div class="mb-2">
            <label for="" class="tw-form-label">Type<span class="text-red-500">*</span></label>
          </div>
          <div class="mb-2">
            <select class="tw-form-control w-full" wire:model.live="type">
            ...
            @error('type')<span class="text-red-600 text-xs font-normal"><strong>{{ $message }}</strong></span>@enderror
          </div>
        </div>
      </div>
      ...
      <svg wire:loading wire:target="submitQualification"
