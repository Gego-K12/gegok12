...
<a href="{{url('/admin/sales/show')}}" title="Back" class="rounded-full bg-gray-100 p-2">
...
<span class="mx-3">Sales Details</span>
</h1>
</div>
   ...
   <div class="w-full lg:w-3/4 lg:mr-8 md:mr-8 custom-table py-4">
        <table class="w-full">
            ...
            <tr class="border-t-2 border-b-2">
                ...
                <td class="py-3 px-2">{{ $salesorder->user->userprofile->firstname }} {{ $salesorder->user->userprofile->lastname }}</td>
            </tr>

            <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Class</td>
                <td class="py-3 px-2">{{  $salesorder->StandardLink->standard->name}} - {{$salesorder->StandardLink->section->name }} </td>
            </tr>

             <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Quantity</td>
                <td class="py-3 px-2">{{ $salesorder->quantity}}  </td>
            </tr>

             <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Selling Price</td>
                <td class="py-3 px-2">{{  $salesorder->selling_price}}</td>
            </tr>

             <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Total Price</td>
                <td class="py-3 px-2">{{  $salesorder->total_price}} </td>
            </tr>

             <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Sales Date</td>
                <td class="py-3 px-2">{{  $salesorder->sales_date}} </td>
            </tr>
