...
use App\Calendar\CalendarServiceProvider;
use App\Conference\ConferenceFacade;
use App\Conference\ConferenceServiceProvider;
...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'Purify' => PurifyServiceProvider::class,
        'PDF' => Facade::class,
        'FCM' => FCM::class,
        'Conference' => ConferenceFacade::class,
