...
@section('content')
	<div class="relative">
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/chapter/show/'.$chapter->id) }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add Question</span>
            </h1>
         </div>
      </div>
      ...
      <create-test-question url="{{ url('/') }}" subject_id="{{$chapter->subject_id}}" chapter_id="{{$chapter->id}}" ></create-test-question>
   </div>
@endsection