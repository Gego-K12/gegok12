...
<div class="w-full lg:mx-2">
    <h1 class="admin-h1 my-3 flex items-center">
        ...
        <span class="mx-3">Add Non-Teaching Staff</span>
    </h1>
    ...
    @else
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded">
            ...
            <p class="text-sm">Please contact your administrator to increase the staff limit.</p>
        </div>
    @endif
</div>
...
@push('scripts')
   <script
  src="https://maps.googleapis.com/maps/api/js?key={{ config('services.google_maps.key') }}&libraries=places,marker"
  async
  defer>
</script>
@endpush
