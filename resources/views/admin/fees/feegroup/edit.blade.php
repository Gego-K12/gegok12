...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/admin/feegroup') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Edit Fee Group</span>
    </h1>
    @include('partials.message')
    <edit-fee-group id="{{ $feegroup->id }}" mode="admin"></edit-fee-group>
</div>
@endsection