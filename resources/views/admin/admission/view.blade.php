...
@section('content')
    <div class="relative">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/admin/admissions') }}" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <span class="mx-3">Admission Application Details</span>
        </h1>
        @include('partials.message')
        @livewire('admin.admission.admission-details', ['admissionId' => $admission->id])
    </div>
@endsection
