      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/admin/leavetypes') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Edit Leave Types</span>
            </h1>
         </div>
      </div>
      <div class="px-4 bg-white shadow block">
      @include('partials.message')
      @include('admin.leavetypes.edit_form')
      </div>
   </div>
@endsection
