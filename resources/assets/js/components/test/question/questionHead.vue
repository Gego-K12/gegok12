          ...
          <div class="modal-body" >
            <div class="flex flex-col">
                            ...
                            <div class="my-2 w-full">
                                ...
                                <span v-if="errors.question_head" class="text-red-500 text-xs font-semibold">{{ errors.question_head[0] }}</span>
                            </div>
              </div>
              <div class="flex flex-col">
                            <div class="w-full lg:w-1/4"> 
                            ...
                            <div class="my-2 w-full">
                                ...
                                <span v-if="errors.mark" class="text-red-500 text-xs font-semibold">{{ errors.mark[0] }}</span>
                            </div>
              </div>
               <div class="flex items-center">
