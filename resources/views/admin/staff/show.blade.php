...
@section('content')
    <div>
        ...
        <div class="py-2 mt-2 flex items-center">
            <a href="{{ url('/admin/staffs') }}" class="rounded-full bg-gray-100 hover:bg-gray-200 transition p-2" title="Back">
            ...
            <h1 class="admin-h1 mx-3">Non-Teaching Staff Profile</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow border border-gray-100 mb-5">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 border-b border-gray-100">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">{{ optional($user->latestTeacherProfile)->designation_name ?? '' }} &middot; ID: {{ $user->id }}</p>
                </div>

                <div class="flex flex-wrap items-center gap-2 flex-shrink-0">
                    <a href="{{url('/admin/staff/edit/'.$user->name)}}" title="Edit" class="rounded-full bg-gray-100 hover:bg-gray-200 transition p-2" id="edit">
                    ...
                    <div class="relative">
                        ...
                        <div class="more-actions-menu hidden absolute right-0 mt-1 w-64 bg-white rounded shadow-lg border border-gray-100 py-1 z-10 text-xs">
                            ...
                            <a href="{{url('/admin/staffs/id-card/'.$user->name)}}" title="ID CARD" class="block px-4 py-2 text-gray-700 hover:bg-gray-50">Id Card</a>

                            <div class="border-t my-1"></div>

                            <form action="{{ url('/admin/staff/delete', ['name'=>$user->name]) }}" method="POST" id="delete">
                                @csrf
                                @method('delete')
            ...
            <div class="flex flex-col sm:flex-row gap-5 p-6">
                ...
                <div class="ml-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-3 text-xs w-full">
                    <div>
                        ...
                        <p class="font-semibold text-gray-700">{{ optional($user->latestTeacherProfile)->employee_id ?? '--' }}</p>
                    </div>
                    <div>
        ...
        <div id="deactivate-confirm-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 px-4">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                ...
                <p class="text-sm text-gray-600 mb-4 leading-relaxed">
                    ...
                    Their historical records will stay intact, and you can reactivate this account at any time from the
                    same menu.
                </p>
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-lg p-6">
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <label class="flex items-start gap-2 text-sm text-gray-700 cursor-pointer">
                        ...
                        <span>I understand this will immediately and permanently block their login.</span>
                    </label>
                    <label class="flex items-start gap-2 text-sm text-gray-700 cursor-pointer">
                        <input type="checkbox" class="relieve-ack mt-1" id="relieve-ack-3">
                        <span>I understand their historical records will be preserved, not deleted.</span>
                    </label>
                </div>
                <div class="flex justify-end gap-2">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.verify').on('click', function(){
            ...
            swal({
                icon: "info",
                text: "Do you want to verify email for this staff member ?",
                buttons: {
                    cancel: true,
                    confirm: true,
                },
