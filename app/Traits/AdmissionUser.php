...
trait AdmissionUser
{
     ...
     * @param  User  $admin  Admin performing the operation
     * @return User Newly created student user
     */
     ...
     * @return User Newly created father user
     */
     ...
     * @param  int  $usergroup_id  User group ID for parent role
     * @return User Newly created mother user
     */
