...
<a href="{{url('/admin/products')}}" title="Back" class="rounded-full bg-gray-100 p-2">
...
<span class="mx-3">Product Details</span>
</h1>
</div>
   ...
   <div class="w-full lg:w-3/4 lg:mr-8 md:mr-8 custom-table py-4">
        <table class="w-full">
            ...
            <tr class="border-t-2 border-b-2">
                ...
                <td class="py-3 px-2">{{  $product->cost_per_quantity}}</td>
            </tr>

            <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Purchased Date</td>
                <td class="py-3 px-2">{{  $product->purchased_date}} </td>
            </tr>
