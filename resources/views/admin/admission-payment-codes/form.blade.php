...
@section('content')
    <div class="">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('admin/admission-payment-codes') }}" class="rounded-full bg-gray-100 p-2" title="Back">
            ...
            <span class="mx-3">Generate Payment Codes</span>
        </h1>
        @livewire('admin.admission-payment-code.payment-code-form')
    </div>
@endsection
