 ...
 * scheduled command (via App\Services\PluginInstaller). Redirects back to
 * the plugin list (PluginConsole, /plugins) on success.
 */
class StagePluginInstall extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.site-admin.stage-plugin-install');
    }
