  ...
  methods: 
  {
    getMember()
    {
       axios.get('/teacher/video-conference/editlist/'+this.conference_id).then(response => {
          ...
          this.standardlist = response.data.standards.standardLinklist;
          this.subjectlist = response.data.standards.subjectlist;
          ...
          this.standardLink_id=this.conference.standard;
          this.subject_id=this.conference.subject_id;
    ...
    submitForm()
            {
                ...
                axios.post('/teacher/video-conference/update/'+this.conference_id,{
                  name:this.name,
