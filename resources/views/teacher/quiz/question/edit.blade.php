...
@section('content')
	<div class="relative">
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/teacher/quiz/'.$question->topic_id.'/show') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      ...
      <edit-question url="{{ url('/') }}" question_id="{{ $question->id }}"></edit-question>
   </div>
@endsection