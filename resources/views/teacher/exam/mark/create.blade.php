    ...
    <div class="">
        <div class="flex items-center justify-between">
            <h1 class="admin-h1 my-3 flex items-center">
                <a href="{{ url('/teacher/exam') }}" title="Back" class="rounded-full bg-gray-100 p-2">
                ...
                <span class="mx-3">Add Marks</span>
            </h1>
            <!-- <a href="{{ url('/teacher/exammarks/show/'.$schedule->id) }}" id="submit-btn" class="btn btn-submit blue-bg text-white rounded px-3 py-1 mr-3 text-sm font-medium">Export</a> -->
        </div>
        @include('partials.message')
        <create-exam-mark id="{{ $schedule->id }}" url="{{ url('/') }}"></create-exam-mark>  
    </div>
@endsection