...
use Gegok12\Fee\Http\Controllers\Accountant\DashboardController;
...
//fees
           Route::get( '/dashboard/unpaidList/{fee_id}', [DashboardController::class,'unpaidList' ]);
           Route::get( '/dashboard/feeslist/{fee_id}', [DashboardController::class,'feeslist' ]);
           Route::get( '/dashboard/unpaidfees/{fee_id}', [DashboardController::class,'show' ]);
           Route::post( '/dashboard/send/reminder/{fee_id}', [DashboardController::class,'sendReminder' ]);
			//index
