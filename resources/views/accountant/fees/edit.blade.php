...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/accountant/fees') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Edit Fee</span>
    </h1>
    @include('partials.message') 
	    @if($fee->fee_type == 'non_structural')
	    	<edit-fee-non-structural id="{{ $fee->id }}" mode="accountant" class_id="{{ $fee->standardLink_id }}"></edit-fee-non-structural> 
	    @elseif($fee->fee_type == 'structural') 
	    	<edit-fee-structural id="{{ $fee->id }}" mode="accountant"></edit-fee-structural> 
	    @endif
</div>
@endsection