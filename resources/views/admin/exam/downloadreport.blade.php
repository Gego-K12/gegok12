...
<div class="px-2">
 ...
 <div><!-- <img src="{{$mark[0]['user']['userprofile']['AvatarPath']}}" class="w-20 h-20 border"> -->
   @if($mark[0]['user']['userprofile']['avatar']!=null)
   <img src="{{$mark[0]['user']['userprofile']['AvatarPath']}}" class="w-20 h-20 border">
   @endif
 </div>
 </div>
 <div class="border">
