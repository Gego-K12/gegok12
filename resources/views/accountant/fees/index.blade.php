...
@section('content')
    <div class="relative">
        <div class="flex flex-wrap lg:flex-row justify-between">
            ...
            <div class="relative flex items-center w-1/4 justify-end">
                <div class="flex items-center">
                    <a href="{{url('/accountant/fee/add')}}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center">
        ...
        <fee-list-tab url="{{ url('/') }}" mode="accountant"></fee-list-tab>
        <div id="list_fee"></div>
   </div>
@endsection