...
@section('content')
    <div class="">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('admin/custom-fields') }}" class="rounded-full bg-gray-100 p-2" title="Back">
            ...
            <span class="mx-3">{{ isset($id) ? 'Edit Custom Field' : 'Add Custom Field' }}</span>
        </h1>
        @livewire('admin.custom-fields.custom-field-form', ['id' => $id ?? null])
    </div>
@endsection
