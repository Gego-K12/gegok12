    ...
    <loading v-model:active="isLoading"
        ...
        <div>
            <h1 class="admin-h1 my-3 flex items-center">
                <a :href="this.url+'/teacher/video-conference/manage-invites/'+this.conference_id" title="Back" class="rounded-full bg-gray-100 p-2">
...
// Import component
  ...
  methods: 
  {
    getMember()
    {
       axios.get('/teacher/video-conference/editlist/'+this.conference_id).then(response => {
    ...
    submitForm()
            {
                ...
                axios.post('/teacher/video-conference/save-invites/'+this.conference_id,{
                  students:this.selected,
                    
                }).then(response => {
                    this.success = response.data.success;
                    this.isLoading=false;
                    window.location.href = "/teacher/video-conference/manage-invites/"+this.conference_id;
                }).catch(error => {
                  this.isLoading=false;
