...
@section('content')
  <div class="relative">
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/test/show/'.$test->id) }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add Pattern</span>
            </h1>
         </div>
      </div>
      ...
      <div class="flex border shadow py-3 px-5 text-white justify-between items-center">
         ...
         <div class="flex">
            <div class="flex-col leading-relaxed">
               <p class="text-gray-700 font-medium">Subject name:<span class="font-semibold">{{ $test->subject->name }} </span></p>
      ...
      <create-test-pattern url="{{ url('/') }}" test_id="{{$test->id}}" subject_id="{{$test->subject_id}}"  ></create-test-pattern>
   </div>
@endsection